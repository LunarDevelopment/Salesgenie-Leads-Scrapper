...
var executive_title = document.querySelectorAll("#resultsGridView tbody tr td:nth-child(3)");

var phone = document.querySelectorAll("#resultsGridView tbody tr td:nth-child(4)");

var street_address = document.querySelectorAll("#resultsGridView tbody tr td:nth-child(5)");

var city = document.querySelectorAll("#resultsGridView tbody tr td:nth-child(6)");

var province = document.querySelectorAll("#resultsGridView tbody tr td:nth-child(7)");
...
for ( n = 0; n < length ; n++ ) {
	...
	var csv = '"Business Name";"Executive Name";"Executive Title";"Phone";"Street Address";"City";"Province";"Postal Code";"Website"\n';
